...
/* Czyszczenie buforu odbiorczego */

uint8_t USART_flush_rx_buff(USART_t * const usart)
{
	uint8_t trash = 0;
	...
	return trash;		// funkcja zwaraca wartosc tylko po to, by uniknac bledu "variable set but not used"
}