 ...
 * print info
 */
void nrf24l01_printinfo(void(*prints)(char *), void(*printc)(char data)) {
	char buff[100];
	prints("nRF info:\r\n");
 ...
 * put data
 */
bool nrf24l01_write(uint8_t *data)
{
	uint8_t i = 0;
	bool ret = false;
...
void nrf24l01_init()
{
	DDR(NRF24L01_CE_PORT) |= (1<<NRF24L01_CE); //output
...
{
	uint8_t result = spi_send_read_byte(data);
	return result;
}
...
{
	nrf24l01_writeregister(NRF24L01_REG_STATUS, (1<<NRF24L01_REG_RX_DR) | (1<<NRF24L01_REG_TX_DS) | (1<<NRF24L01_REG_MAX_RT));
}
...
{
	nrf24l01_writeregister(NRF24L01_REG_STATUS, (1<<NRF24L01_REG_MAX_RT));
}
