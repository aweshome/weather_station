...
//CE port definitions
#define NRF24L01_CE_PORT C
#define NRF24L01_CE 3

//define the spi path
#define NRF24L01_SPIPATH "../Interfaces/spi.h" //spi lib path

//CE functions
#define nrf24l01_CEhi PORT(NRF24L01_CE_PORT) |=  (1<<NRF24L01_CE)
#define nrf24l01_CElo PORT(NRF24L01_CE_PORT) &= ~(1<<NRF24L01_CE)
...
#define NRF24L01_CH 94

//payload lenght
#define NRF24L01_PAYLOAD 11
...
#define NRF24L01_RETR (0b1111 << NRF24L01_REG_ARD) | (0b1111 << NRF24L01_REG_ARC) // 4 ms, 15 times
...
extern bool nrf24l01_write(uint8_t *data);
...
extern void nrf24l01_printinfo(void(*prints)(char *), void(*printc)(char data));
#endif
